...
int main()
{
    ...
    if (planeType == 1)
    {
        ...
        // Calculate the total weight of the plane
         totalPlaneWeight = totalLuggageWeight + totalPassengerWeight + totalCrewWeight;
    ...
    printf("plane weighs: %d\n", message.plane.totalPlaneWeight);
 ...
 //   sleep(DEBOARDING_TIME); // deboarding/unloading process
    ...
    while(msgrcv(msgid, &message, sizeof(message), planeID+30, 0) == -1){};
